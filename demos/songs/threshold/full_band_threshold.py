#!/usr/bin/env python3
"""
Full Band Threshold Demo - Threshold-based evolution version of full_band_demo.

Uses fitness thresholds to evolve until reaching quality targets
rather than fixed generation counts.
"""
...
def main():
    ...
    # Melody (piano) - matching full_band_demo
    ...
    composer.add_instrument(InstrumentConfig(
        ...
        gain=0.5,
        play_in_sections=[SectionType.INTRO, SectionType.VERSE, SectionType.CHORUS, SectionType.BRIDGE],
    ))
    ...
    print("=" * 60)
    print(strudel_link)
    print("\n✅ Threshold-based full band song complete!")
